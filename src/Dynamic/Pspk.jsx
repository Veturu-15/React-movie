        ...
        {movie ? (
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <div className="flex flex-col items-center">
              <img src={movie.heronieimg} alt={movie.heronieimg} className="w-32 h-32 object-Fullcover  mb-2" />
              <p className="text-lg font-semibold">{movie.Heroninename}</p>
              <p className="text-sm">{movie.heroninechar}</p>
              </div>
              <div className="flex flex-col items-center">
              <img src={movie.charimg} alt={movie.charimg} className="w-32 h-32 object-Fullcover  mb-2" />
              <p className="text-lg font-semibold">{movie.charaname}</p>
              <p className="text-sm">{movie.chara}</p>
              </div>
              <div className="flex flex-col items-center">
              <img src={movie.chari} alt={movie.chari} className="w-32 h-32 object-Fullcover  mb-2" />
